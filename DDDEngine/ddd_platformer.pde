class Platformer {
  ...
  HashMap start(){
    ...
    for(int i = 0; i < floors; i++){
      ...
      Object enemy = new Object("./Images/Enemy.png", false, false, false, new PVector(0, 0, 0), new PVector(50, 50, 0), new PVector(x, prev_obj.rb.position.y +  y - (int) random(0, 50), z1), new PVector(0, 0), 5, 0);
      prev_obj = floor;
