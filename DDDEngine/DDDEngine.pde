...
void setup(){
  ...
  objects.put("Player", new Object("./Images/fiend.png", true, true, true, new PVector(0, 0, 0), new PVector(200, 200, 10), new PVector(200f, 200f, 1f), new PVector(0, 0), 5));
...
void draw(){
  ...
  background(255);  
  noFill();
  println("Before phys", objects.get("Player").rb.dimensions.x);
  objects = PhysicsEngine.SimulatePhysics(objects);
  println("After phys", objects.get("Player").rb.dimensions.x);
